...
for i in range(7):
    ...
    if target_splits[i] >= 0:
        for idx in range(target_splits[i] + 1):
            cpp_targets_autogen_splits.append("src/autogen/" + OVRNAME + "_" + str(idx) + ".c")
    if i == 0:
...
cpp_targets = cpp_targets_autogen + cpp_targets_autogen_splits + \
              cpp_targets_autogen_end + cpp_targets_end
