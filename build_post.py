...
mainexe_dirs = ["asm/data",
                ...
                "asm/nonmatchings/autogen/ovr0_7",
                "asm/nonmatchings/autogen/ovr0_8",
#                "asm/nonmatchings/autogen/ovr0_9",
#                "asm/nonmatchings/autogen/ovr0_A",
#                "asm/nonmatchings/autogen/ovr0_B",
...
ovr2_dirs = ["asm/nonmatchings/autogen/ovr2",
             #"asm/ovr2",
             #"src/ovr2"
             ]
ovr2_decomped_dirs = ["src/ovr2"]
ovr3_dirs = ["asm/nonmatchings/autogen/ovr3",
             #"asm/ovr3",
             #"src/ovr3"
             ]
ovr3_decomped_dirs = ["src/ovr3"]
ovr4_dirs = ["asm/nonmatchings/autogen/ovr4",
             #"asm/ovr4",
             #"src/ovr4"
             ]
ovr4_decomped_dirs = ["src/ovr4"]
ovr5_dirs = ["asm/nonmatchings/autogen/ovr5",
             #"asm/ovr5",
             #"src/ovr5"
             ]
ovr5_decomped_dirs = ["src/ovr5"]
ovr6_dirs = ["asm/nonmatchings/autogen/ovr6",
             #"asm/ovr6",
             #"src/ovr6"
             ]
...
def count_ns(symbol_addr_filename):
    ...
    if os.path.isfile(filepath) is True:
        with open(filepath, encoding="utf-8") as f:
            for line in f:
                if "/" not in line or not line.isspace():
                    named_symbols += 1
...
mainexe_dcs_fc = len(mainexe_files) + len([1 for x in mainexe_decomped_dirs_list if x.is_file()])
...
overall_count = mainexe_count + ovr1_count + ovr2_count + ovr3_count + \
                ovr4_count + ovr5_count + ovr6_count
overall_ns_count = MAINEXE_NS_COUNT + OVR1_NS_COUNT + OVR2_NS_COUNT + \
                   OVR3_NS_COUNT + OVR4_NS_COUNT + OVR5_NS_COUNT + OVR6_NS_COUNT
overall_ms_fc = mainexe_ms_fc + ovr1_ms_fc + ovr2_ms_fc + ovr3_ms_fc + \
                ovr4_ms_fc + ovr5_ms_fc + ovr6_ms_fc
overall_dcs_fc = mainexe_dcs_fc + ovr1_dcs_fc + ovr2_dcs_fc + ovr3_dcs_fc + \
                 ovr4_dcs_fc + ovr5_dcs_fc + ovr6_dcs_fc
...
print_symbols("main_exe", mainexe_count, MAINEXE_NS_COUNT, mainexe_ms_fc, mainexe_dcs_fc)
...
print_symbols(" overall", overall_count, overall_ns_count, overall_ms_fc, overall_dcs_fc)
